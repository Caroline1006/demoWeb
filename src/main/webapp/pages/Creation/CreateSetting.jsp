...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="background-color: #f1f1f1">
        <!-- 内容主体区域 -->
        <div class="layui-col-md9" style="margin-top: 20px;margin-left: 150px">
            <div class="layui-panel" style=" width: 1035px;height:605px">
                <div style="padding: 30px;">
                    <p style="font-size: 23px">创作设置</p>
                    <div class="layui-row layui-col-space15">
                        <div class="layui-col-md10" style="margin-top: 18px">
