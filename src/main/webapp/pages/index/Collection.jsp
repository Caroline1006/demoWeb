...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="background-color:#f1f1f1">
        ...
        <div class="layui-col " style="float:left ;margin-top:20px;margin-left: 20px ">
            <div class="layui-panel " style="height: 600px;width: 150px">
                <div>
                    <ul class="layui-nav layui-nav-tree" lay-filter="test"
                        style="margin-top: 20px;height:500px;background-color:white">
                        <li class="layui-nav-item layui-nav-itemed">
                            <button class="layui-btn layui-btn-primary layui-border-blue" id="btn"
                                    style="margin-left: 20px"><p style="color:black">新建文件夹</p></button>
                            <button class="layui-btn layui-btn-primary layui-border-blue" id="btn4"
                                    style="margin-left: 20px"><p href="" style="color:black">默认文件夹</p></button>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="layui-col-md6 " style="float:left ;margin-top:20px;margin-left: 0 ">
            <div class="layui-panel " style="height: 600px;width:680px">
