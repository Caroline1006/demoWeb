...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="background-color:#f1f1f1">
        ...
        <div class="layui-col-md6 " style="float:left ;margin-top:20px;margin-left: 20px ">
            <div class="layui-panel " style="height: 250px;width:880px">
                <div style="padding: 30px;">
                    ...
                    <div class="layui-row">
                        <div class="layui-col" style="height:70px;margin-top: 30px">
                            <div>
                                <img src="../../img/qian/学校.png" style="width: 23px;height: 23px">
                                <a style="font-size: 15px;margin-left: 30px">教育信息</a> <a
                                    style="font-size: 12px;margin-left: 30px">开启后在个人主页等模块向他人展示教育信息</a>
                        ...
                        <div class="layui-col" style="height:70px">
                            <div><img src="../../img/qian/公司.png" style="width: 28px;height: 28px"> <a
                                    style="font-size: 15px;margin-left: 30px">工作信息</a> <a
                                    style="font-size: 12px;margin-left: 30px">
                                开启后在个人主页等模块向他人展示工作信息</a>
                                <button type="button" class="layui-btn layui-btn-primary layui-border-blue"
                                        style="float: right">设置
                                </button>
                            </div>
